...
sorteio_loop_generico:
    ...
    # transforma 11, 12, 13 em valores de 10
    li s7, 10
    li s8, 11
    bge t6, s8, usar_dez
    mv s7, t6
...
inicio_jogo:
    ...
    # Calcular total da mão do player após as duas cartas iniciais
    la a0, mao_player
    la a1, num_cartas_player
    la a2, total_player
    ...
    # Calcular total da mão do dealer após as duas cartas iniciais
    la a0, mao_dealer
    la a1, num_cartas_dealer
    la a2, total_dealer
    jal calcula_total_mao
